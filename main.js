...
const plus = document.querySelector(".section7-contain__imgbox-img");
const minus = document.querySelector(".section7-contain__imgbox-img-minus");
...
const imgbox = document.querySelector('.section7-contain__imgbox');
